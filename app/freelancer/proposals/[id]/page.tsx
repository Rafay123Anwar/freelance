...
import { Calendar, DollarSign, ArrowLeft, Clock } from "lucide-react"
      ...
      <ProtectedRoute allowedUserTypes={["freelancer"]}>
        <DashboardLayout>
          <div className="flex flex-col items-center justify-center py-10">
            ...
            <Button className="mt-4" onClick={() => router.push("/freelancer/proposals")}>
              View All Proposals
            </Button>
          </div>
        </DashboardLayout>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="md:col-span-2 space-y-6">
              <Card>
                ...
                <CardFooter>
                  <Link href={`/jobs/${proposal.job}`} className="w-full">
              ...
              <Card>
                ...
                <CardFooter className="flex justify-end py-4">
                  {proposal.status === "pending" && (
                    <Button variant="destructive" onClick={handleWithdrawProposal} disabled={isWithdrawing}>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      Your proposal has been accepted! You can now communicate with the client to discuss the project
                      details.
                    </p>
                  </CardContent>
                  <CardFooter>
                    <Link href={`/messages/rooms/${proposal.job}`} className="w-full">
                      <Button className="w-full">Message Client</Button>
                    </Link>
                  </CardFooter>
                </Card>
              )}
