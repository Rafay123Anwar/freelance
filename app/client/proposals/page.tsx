...
import { z } from "zod"
import { Calendar, DollarSign, Filter, MessageSquare } from "lucide-react"
...
export default function ClientProposalsPage() {
  ...
  const fetchJobs = async () => {
    try {
      const response = await api.get("/api/jobs/?client=true")
      setJobs(
  ...
  const fetchProposals = async (filters = {}) => {
    ...
    try {
      ...
      // Get all proposals for all client's jobs
            ...
            {isLoading ? (
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <div className="flex items-center text-sm text-muted-foreground mt-1">
                          <span>For: {proposal.job_details.title}</span>
                        </div>
                      </div>
                      <div
              ...
              <Card>
                <CardContent className="flex flex-col items-center justify-center py-10">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">You haven't received any proposals yet</p>
                </CardContent>
              </Card>
            )}
          </div>
